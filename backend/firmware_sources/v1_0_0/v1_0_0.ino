...
const char* current_version = "1.0.0"; // Version 1.0.0
...
void setup() {
    ...
    Serial.println("\n[BOOT] ========================================");
    Serial.println("[BOOT] ESP32 Production OTA Client: Version 1.0.0");
    ...
    Serial.println("[BOOT] Behaviour: Slow Blinking LED (3 seconds interval)");
    Serial.println("[BOOT] ========================================");
...
void loop() {
    ...
    // Version 1.0.0 behavior: Slow blink (every 3000 ms)
    if (millis() - lastBlinkTime >= 3000) {
        lastBlinkTime = millis();
        ledState = !ledState;
        digitalWrite(LED_PIN, ledState ? HIGH : LOW);
        Serial.println("[v1.0.0] Blinking LED (Slow) - Running normal operation...");
    }
